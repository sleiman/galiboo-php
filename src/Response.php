...
class Response implements \ArrayAccess
{
     ...
     */
    public function __construct( $galiboo, $request, $content )
    {
    ...
    private function loadRelatedField( $related_field, $related_table, $record )
    {
        ...
        {
            $relation_request = $this->galiboo->getContent( "$related_table", [
        ...
        else
        {
            ...
            $relation_request = $this->galiboo->getContent( "$related_table_name", [
                'filterByFormula'       => $relation_formula
